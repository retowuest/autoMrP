#' A sample from 2008 Cooperative Congressional Election Studies item cc418_1.
#'
...
#' \describe{
#'   \item{YES}{1 if individual suuports the use of troops and 0 otherwise}
...
#'   \item{region}{Region in the U.S. the respondent is from; 1 = something, 2 = something, 3 = something, 4 = something}
